...
export default function AttendanceParents() {
        ...
        <div className="text-white">
          <div className="flex justify-between items-center">
            ...
            {studentData.length > 1 && (
              <div className="flex gap-4 mt-2 max-w-[12rem]">
                <Select
                  onValueChange={(value) =>
                    setSelectedStudent(
                      studentData.find((student) => student.id === value) ||
                        studentData[0]
                    )
                  }
                >
          ...
          <p className="mt-2">
            {selectedStudent.name} - {selectedStudent.grade} Grado, Sección{" "}
