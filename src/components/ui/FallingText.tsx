...
const FallingText: React.FC<FallingTextProps> = ({
    ...
    return (
        <div
            ref={containerRef}
            className="relative z-[1] w-full h-[90vh] cursor-pointer text-center pt-8 overflow-hidden"
        ...
        >
            ...
            <div className="absolute top-0 left-0 z-0 w-90 h-90" ref={canvasContainerRef} />
        </div>
    );
};
